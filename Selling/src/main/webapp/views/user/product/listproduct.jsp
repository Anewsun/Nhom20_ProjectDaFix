...
<head>
<link href="/../fix/bootstrap532.min.css" rel="stylesheet"
	integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN"
	crossorigin="anonymous">
<link rel="stylesheet" href="/../fix/all.min.css">
<link
...
<body>
	...
	<script src="/../fix/popper.min.js"
		integrity="sha384-I7E8VVD/ismYTF4hNIPjVp/Zjvgyol6VFvRkX/vR+Vc4jQkC+hVqc2pM8ODewa9r"
		crossorigin="anonymous"></script>
	<script src="/../fix/bootstrap.min.js"
	...
	<script>
		...
		var currentPage = parseInt(urlParams.get('page')) || 1; // Default to 1 if page parameter is not present or invalid

		// If currentPage is NaN or less than 1, set it to 1
		if (isNaN(currentPage) || currentPage < 1) {
			currentPage = 1;
		}

		// Replace the page parameter in the URL with the corrected value
		var correctedUrl = currentUrl.replace(/page=-?\d+/, "page="
				+ currentPage);
